...
namespace Tests\Unit\Drafling\Domain\Model;
...
final class ProjectTest extends TestCase
{
    public function testProjectConstruction(): void
    {
        ...
        $this->assertSame('/path/to/project', $project->projectPath);
    }
    ...
    public function testProjectConstructionWithDefaults(): void
    {
        ...
        $this->assertNull($project->projectPath); // Should default to null
    }
    ...
    public function testGenerateDirectoryName(): void
    {
        $project = new Project(
            id: 'proj_dir',
        ...
        $this->assertSame('my-blog-project', $project->generateDirectoryName());
    }

    public function testGenerateDirectoryNameWithSpecialCharacters(): void
    {
        $project = new Project(
            id: 'proj_special',
            name: 'My  Blog   Project!!!  @#$',
    ...
    public function testGetConfiguration(): void
    {
        ...
        $this->assertSame($expected, $project->getConfiguration());
    }
    ...
    public function testJsonSerialize(): void
    {
        ...
        $this->assertSame('proj_json', $serialized['project_id']);
        $this->assertSame('JSON Test', $serialized['title']);
        $this->assertSame('published', $serialized['status']);
        $this->assertSame('api', $serialized['project_type']);
        ...
        $this->assertSame(['endpoints'], $serialized['metadata']['entry_dirs']);
