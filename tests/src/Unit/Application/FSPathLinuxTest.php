...
final class FSPathLinuxTest extends TestCase
{
    ...
    {
        $path = FSPath::create(path: '/home/user/test');
    ...
    {
        $base = FSPath::create(path: '/home/user');
    ...
    {
        $path = FSPath::create(path: '/home/user/document.txt');
    ...
    public function it_should_handle_root_paths(): void
    {
        ...
        $this->assertSame('/', $root->withName(name: 'test')->toString());
        $this->assertSame('/', $root->withExt(suffix: 'txt')->toString());
        $this->assertSame('/', $root->withStem(stem: 'test')->toString());
    }

    #[Test]
    public function it_should_check_path_types(): void
    {
        $absolutePath = FSPath::create(path: '/home/user');
        $this->assertTrue($absolutePath->isAbsolute());
        $this->assertFalse($absolutePath->isRelative());

        $relativePath = FSPath::create(path: 'home/user');
    ...
    public function it_should_normalize_paths(): void
    {
        ...
        // Dot segments
        $path = FSPath::create(path: '/home/./user/../admin');
    ...
    {
        $path = FSPath::create(path: '/home/user/documents/file.txt');
    ...
    {
        $path = FSPath::create(path: '/home/user');
    ...
    public function it_should_make_paths_absolute(): void
    {
        ...
        $relative = FSPath::create(path: 'html/css');
    ...
    public function it_should_check_file_operations(): void
    {
        ...
        $path = FSPath::create(path: '/tmp/test-file.txt');
    ...
    {
        $path = FSPath::create(path: '/home/user/document');
        ...
        $newPath = $path->withExt(suffix: 'txt');
    ...
    protected function setUp(): void
    {
        ...
        if (DIRECTORY_SEPARATOR !== self::LINUX_DIRECTORY_SEPARATOR) {
            FSPath::setDirectorySeparator(separator: self::LINUX_DIRECTORY_SEPARATOR);
