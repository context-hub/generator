...
use Butschster\ContextGenerator\Drafling\Storage\FileStorage\DirectoryScanner;
...
final class DirectoryScannerTest extends TestCase
{
    ...
    public function it_scans_projects_correctly(): void
    {
        ...
        $projects = $this->scanner->scanProjects($projectsPath);
        ...
        foreach ($projects as $projectPath) {
            $this->assertFileExists($projectPath . '/project.yaml');
        }
    }
    ...
    public function it_returns_empty_array_for_nonexistent_projects_path(): void
    {
        ...
        $projects = $this->scanner->scanProjects($nonexistentPath);
...
MARKDOWN;
    ...
    protected function setUp(): void
    {
        ...
        $this->testDataPath = \dirname(__DIR__, 5) . '/fixtures/Drafling/FileStorage';
